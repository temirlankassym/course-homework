...
<body>
    <div style="background-color: #0073c3; width: 500px;height: 500px;justify-content: center;display: flex;align-items: center;">
        <form action="/register" method="post" style="padding-top:0px;width: 300px;display: flex; flex-direction: column; gap: 10px;">
            @csrf
            <h1>Register</h1>
            <input style="border-width: 0px;height: 30px" type="text" name="username" placeholder="username">
            ...
            <input style="border-width: 0px;margin-top:5px;height: 30px" type="password" name="password_confirm" placeholder="password confirmation">
            <button style="margin-top: 40px; width: 100px" class="btn btn-primary" type="submit">Register</button>
